# This Makefile is for the HTML::Chunks extension to perl.
#
...
#     NAME => q[HTML::Chunks]
#     VERSION_FROM => q[lib/HTML/Chunks.pm]
...
AR_STATIC_ARGS = cr
NAME = HTML::Chunks
DISTNAME = HTML-Chunks
NAME_SYM = HTML_Chunks
VERSION = 1.51
VERSION_SYM = 1_51
XS_VERSION = 1.51
...
PARENT_NAME = HTML
DLBASE = $(BASEEXT)
VERSION_FROM = lib/HTML/Chunks.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = lib/HTML/.Chunks.pm.swp \
	lib/HTML/ChunkLocal.pm \
	lib/HTML/Chunks.pm

PM_TO_BLIB = lib/HTML/Chunks.pm \
	blib/lib/HTML/Chunks.pm \
	lib/HTML/ChunkLocal.pm \
	blib/lib/HTML/ChunkLocal.pm \
	lib/HTML/.Chunks.pm.swp \
	blib/lib/HTML/.Chunks.pm.swp
...
manifypods : pure_all lib/HTML/Chunks.pm
	@$(POD2MAN) \
	lib/HTML/Chunks.pm \
	$(INST_MAN3DIR)/HTML::Chunks.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/HTML/Chunks.pm blib/lib/HTML/ChunkLocal.pm blib/lib/HTML/.Chunks.pm.swp
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"1,51,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT></ABSTRACT>\n\t<AUTHOR></AUTHOR>\n}" > $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/HTML/Chunks.pm blib/lib/HTML/Chunks.pm lib/HTML/ChunkLocal.pm blib/lib/HTML/ChunkLocal.pm lib/HTML/.Chunks.pm.swp blib/lib/HTML/.Chunks.pm.swp}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
